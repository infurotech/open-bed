...
export const metadata: Metadata = {
  title: "Avatars - Open Bed",
  description: "Avatar components for Open Bed healthcare management system - User profile images with online, offline, and busy status indicators",
};

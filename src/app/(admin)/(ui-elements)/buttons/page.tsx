...
export const metadata: Metadata = {
  title: "Buttons - Open Bed",
  description: "UI Button components for Open Bed healthcare management system - Primary, secondary, and outline button styles with icons",
};
